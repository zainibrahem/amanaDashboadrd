...
const Customizer = (props) => {
  ...
  const renderSkinsRadio = () => {
    ...
    return skinsArr.map((radio, index) => {
      ...
      return (
        <CustomInput key={index} type='radio' id={radio.name} label={radio.label} checked={radio.checked} onChange={() => setSkin(radio.name)} className={classnames({ 'mr-1': marginCondition })} />
      );
    });
  };
        ...
        <div className='px-2'>
          ...
          <FormGroup className='mb-2'>
            ...
            <div className='d-flex'>
              <CustomInput type='radio' id='full-width' className='mr-1' label='Full Width' checked={contentWidth === 'full'} onChange={() => setContentWidth('full')} />
          ...
          <FormGroup className='mb-2'>
            <div className='d-flex'>
              ...
              <CustomInput type='switch' id='rtl' name='RTL' checked={true} onChange={() => setIsRtl(isRtl)} />
            </div>
          </FormGroup>
        ...
        <div className='px-2'>
          ...
          <FormGroup className='mb-2'>
            <div className='d-flex align-items-center'>
              <CustomInput type='radio' id='vertical-layout' label='Vertical' checked={layout === 'VerticalLayout'} onChange={() => setLayout('vertical')} className='mr-1' />
              <CustomInput type='radio' id='horizontal-layout' label='Horizontal' checked={layout === 'HorizontalLayout'} onChange={() => setLayout('horizontal')} />
            </div>
          </FormGroup>
          {layout !== 'HorizontalLayout' ? (
            <FormGroup className='mb-2'>
              <div className='d-flex align-items-center'>
                ...
                <CustomInput type='switch' id='menu-collapsed' name='menu-collapsed' checked={menuCollapsed} onChange={() => setMenuCollapsed(!menuCollapsed)} />
              </div>
            </FormGroup>
          ) : null}
