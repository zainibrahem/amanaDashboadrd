...
import '../tables/data-tables/style.css';

// ** Table Intl Column

export const Columns_return_custom = [
  {
    selector: 'image',
    sortable: true,
    minWidth: '50px',
    cell: (row) => {
      return <img src={`https://amanacart.com/image/${row.image ? row.image.path : ''}`} style={{ width: '30px', borderRadius: '26px' }} />;
    },
  },
  {
    name: 'الاسم',
