...
export const iconsData = [
  {
    ...
    content: 'تم دفع الفواتير للشركة.',
  ...
  {
    title: 'اجتماع العميل',
    content: 'اجتماع المشروع مع جون @ 10: 15 صباحًا.',
    meta: '45 min ago',
    icon: <User size={14} />,
    color: 'secondary',
    customContent: (
  ...
  {
    title: 'تقرير مالي',
    content: 'انقر فوق الزر أدناه لقراءة التقارير المالية',
    meta: '2 hours ago',
      ...
      <Fragment>
        ...
        <UncontrolledCollapse toggler='#reportToggler2'>
          <ListGroup className='mt-1' flush>
            <ListGroupItem className='list-group-item d-flex justify-content-between flex-wrap'>
              <span>
                ربح العام الماضي: <span className='font-weight-bold'>$20000</span>
              </span>
              <Share2 size={17} />
            </ListGroupItem>
            <ListGroupItem className='list-group-item d-flex justify-content-between flex-wrap'>
              <span>
                ربح هذا العام: <span className='font-weight-bold'>$25000</span>
              </span>
              <Share2 size={17} />
            </ListGroupItem>
            <ListGroupItem className='list-group-item d-flex justify-content-between flex-wrap'>
              <span>
                عمولة العام الماضي : <span className='font-weight-bold'>$5000</span>
              </span>
              <Share2 size={17} />
            </ListGroupItem>
            <ListGroupItem className='list-group-item d-flex justify-content-between flex-wrap'>
              <span>
                عمولة هذا العام: <span className='font-weight-bold'>$7000</span>
              </span>
              <Share2 size={17} />
            </ListGroupItem>
            <ListGroupItem className='list-group-item d-flex justify-content-between flex-wrap'>
              <span>
                إجمالي الرصيد لهذا العام: <span className='font-weight-bold'>$70000</span>
              </span>
              <Share2 size={17} />
            </ListGroupItem>
          </ListGroup>
