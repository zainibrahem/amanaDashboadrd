  ...
  return (
    <Card className='card-app-design'>
      <CardBody>
        ...
        <CardTitle className='mt-1 mb-75'>تصميم التطبيق</CardTitle>
        <CardText className='font-small-2 mb-2'>يمكنك البحث فقط عن المنشورات والاقتباسات ذات الصلة بـ IOS مثل تصميم تطبيقات ipad وتطبيق iphone design</CardText>
        <div className='design-group mb-2 pt-50'>
          <h6 className='section-label'>الفريق</h6>
        ...
        <div className='design-group pt-25'>
          <h6 className='section-label'>الاعضاء</h6>
