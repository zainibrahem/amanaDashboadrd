...
import { Card, CardHeader, CardTitle, CardBody, CardText, UncontrolledDropdown, DropdownMenu, DropdownItem, DropdownToggle } from 'reactstrap';
...
const Sales = (props) => {
  const options = {
      ...
      plotOptions: {
        radar: {
          polygons: {
            strokeColors: ['#f39c12', 'transparent', 'transparent', 'transparent', 'transparent', 'transparent'],
      ...
      <CardBody>
        <div className='d-inline-block mr-1'>
          <div className='d-flex align-items-center'>
            ...
            <h6 className='mb-0'>المبيعات</h6>
          </div>
        </div>
        <div className='d-inline-block'>
          <div className='d-flex align-items-center'>
            <Circle size={13} className='text-info mr-50' />
            <h6 className='mb-0'>الزيارات</h6>
          </div>
        </div>
