...
import { Card, CardTitle, Row, Col, Button, UncontrolledButtonDropdown, DropdownMenu, DropdownItem, DropdownToggle, Input } from 'reactstrap';
      ...
      <Row className='mx-0'>
        <Col className='revenue-report-wrapper' md='8' xs='12'>
          <div className='d-sm-flex justify-content-between align-items-center mb-3'>
            <h4 className='mb-50 mb-sm-0'>Revenue Report</h4>
            <div className='d-flex align-items-center'>
              <div className='d-flex align-items-center mr-2'>
                <span className='bullet mr-50 cursor-pointer' style={{ backgroundColor: 'rgb(1 1 1)' }}></span>
                <span>Earning</span>
              </div>
              <div className='d-flex align-items-center'>
